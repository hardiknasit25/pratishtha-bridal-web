          ...
          <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={errors.PhoneNo ? "border-red-500 focus:border-red-500" : ""}
              />
              {errors.PhoneNo && (
                <p className="text-sm text-red-500 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={errors.Agent ? "border-red-500 focus:border-red-500" : ""}
              />
              {errors.Agent && (
                <p className="text-sm text-red-500 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onBlur={handleInputBlur}
                className={errors.Transport ? "border-red-500 focus:border-red-500" : ""}
              />
              {errors.Transport && (
                <p className="text-sm text-red-500 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onBlur={(e) => handleInputChange("Quantity", Number(e.target.value))}
                          onKeyPress={(e) => {
                          ...
                          placeholder="1"
                          className={fieldErrors.Quantity ? "border-red-500 focus:border-red-500" : ""}
                        />
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onBlur={(e) => handleInputChange("UnitPrice", Number(e.target.value))}
                          onKeyPress={(e) => {
                          ...
                          placeholder="0.00"
                          className={fieldErrors.UnitPrice ? "border-red-500 focus:border-red-500" : ""}
                        />
            ...
            <div className="space-y-2">
              ...
              <Input
                id="totalAmount"
                type="text"
                value={formatCurrency(orderDetails.reduce(
                  (sum, detail) => sum + detail.TotalPrice,
                  0
                ))}
                readOnly
